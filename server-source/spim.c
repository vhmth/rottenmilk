...
/* $Header: /usr/local/cvsroot/spimbot/spim.c,v 1.2 2004/01/27 17:15:24 craig Exp $
*/
...
#endif
{
  write_output (message_out, "Reg %d = 0x%08x (%d)\n", reg_no, reg_image.R[reg_no], reg_image.R[reg_no]);
  return (1);
}
